  ...
  return (
    <div className="fixed bottom-6 sm:bottom-8 left-1/2 -translate-x-1/2 z-40">
      <button
        ...
        aria-label="Наверх"
      >
        <div className="flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-synergy-red border-2 border-synergy-beige shadow-lg hover:shadow-2xl hover:scale-110 transition-all duration-300 scroll-to-top-float">
          <Icon name="Mouse" size={24} className="sm:w-7 sm:h-7 text-synergy-beige" />
        </div>
