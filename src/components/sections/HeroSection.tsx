        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <div className="mb-8 space-y-3 text-synergy-beige/80 px-4">
            ...
            <div className="flex items-center justify-center gap-2 text-sm sm:text-base md:text-lg flex-wrap">
              ...
              <span className="font-semibold text-center">Отель «Экватор», ул. Набережная, д. 20</span>
            </div>
          </div>
          <div className="flex justify-center px-4 mb-4">
            <div className="relative w-full max-w-md">
              ...
              >
                ...
                <span className="uppercase tracking-wide sm:tracking-wider leading-tight">ДА, Я ХОЧУ РАЗОБРАТЬСЯ В ИИ</span>
