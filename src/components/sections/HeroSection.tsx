...
const HeroSection = ({ seatsLeft, scrollToForm }: HeroSectionProps) => {
  return (
    <section 
      className="relative text-synergy-beige px-4 sm:px-6 overflow-hidden bg-cover bg-center bg-no-repeat h-screen flex items-center" 
      style={{ 
        zIndex: 10,
        ...
        <div className="text-center">
          <div className="flex justify-center mb-3 sm:mb-4">
            <img
              ...
              className="h-36 sm:h-48 md:h-56 w-auto object-contain drop-shadow-2xl rounded-lg"
            />
          </div>
          <p className="text-xs sm:text-sm md:text-base font-semibold mb-3 sm:mb-4 text-synergy-beige/90 max-w-2xl mx-auto px-2 leading-relaxed">
            300 предпринимателей, 8 инструментов ИИ, 1 день — и ты уже можешь зарабатывать. Без теории. Только реальные кейсы.
          </p>
          <div className="mb-4 flex items-center justify-center gap-4 sm:gap-8 flex-wrap text-synergy-beige/80 px-4">
            ...
            <div className="flex items-center gap-1.5 text-sm sm:text-base">
              ...
              <span className="font-semibold">Отель «Экватор», Владивосток</span>
            </div>
          </div>
          <div className="flex justify-center px-4 mb-3">
            <div className="relative w-full max-w-md">
              ...
              <Button 
                ...
                className="hero-cta-button relative z-10 w-full text-base sm:text-lg md:text-xl px-6 sm:px-10 py-4 sm:py-6 h-auto font-black bg-synergy-red text-synergy-beige hover:bg-synergy-red border-4 border-synergy-beige shadow-2xl flex items-center justify-center"
              >
                <Icon name="Zap" size={18} className="mr-2 animate-pulse flex-shrink-0" />
                <span className="uppercase tracking-wide leading-tight">ДА, Я ХОЧУ РАЗОБРАТЬСЯ В ИИ</span>
                <Icon name="ArrowRight" size={18} className="ml-2 flex-shrink-0" />
              </Button>
            </div>
          </div>
