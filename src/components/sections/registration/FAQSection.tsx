...
const FAQSection = () => {
  const faqs = [
    {
      q: 'Куда идут деньги?',
      a: '100% средств от продажи билетов полностью передаются в КГКУ «Маяк» (https://ddvl4.ru) — комплексный центр помощи семье и детям. Это благотворительное мероприятие.'
    },
    {
    ...
    },
    {
      ...
      a: 'Мероприятие проходит в отеле «Экватор», ул. Набережная, д. 20, г. Владивосток.'
    },
    {
