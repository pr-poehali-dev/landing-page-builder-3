...
📅 **18 апреля 2026** во Владивостоке

Выбери интересующий вопрос или напиши свой:
...
Просто напиши номер вопроса или задай свой!'''
...
Точный адрес площадки и схема проезда будут отправлены на email после покупки билета.
...
🎯 **Важно:** 100% средств от продажи билетов передаются в Центр «Живая Надежда» — благотворительную организацию, которая помогает одиноким матерям в Приморье.
...
🎯 **100% средств** от продажи билетов идут в Центр «Живая Надежда»

👩‍👧 **Кому помогаем?**
Центр поддерживает одиноких матерей в Приморском крае, предоставляя:
• Материальную помощь
